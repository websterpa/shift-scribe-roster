...
import { Calendar, Users, FileText, Settings, FolderOpen, Archive, Zap, TestTube, FlaskConical, BarChart3, TrendingUp } from 'lucide-react';
...
const Navigation = () => {
  ...
  const navigationItems = [
    ...
    { path: '/reports', label: 'Reports', icon: TrendingUp, gradient: 'from-emerald-500 to-green-600' },
