 ...
 * 
 * Maps database-readable shift names and variants to single-letter tokens
 * used throughout the UI and roster logic.
 * 
 * @module services/roster/helpers/normalizeShift
 */
