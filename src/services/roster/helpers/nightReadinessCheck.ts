...
/**
 * Night Shift Readiness Validation
 * 
 * Checks if staff and configuration are ready for night shift generation.
 * 
 * @module services/roster/helpers/nightReadinessCheck
 */
