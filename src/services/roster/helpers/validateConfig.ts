 ...
 * 
 * Validates roster configuration and results against expected constraints,
 * particularly night shift requirements.
 * 
 * @module services/roster/helpers/validateConfig
 */
